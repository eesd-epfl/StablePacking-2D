"""
Main file for packing fft stones
Switch between the examples by commenting/uncommenting the corresponding lines (stone_images_dir).
The results are stored in five folders with the same prefix, corresponding to five different layouts.
"""
import matplotlib
import os
import pathlib
...
#create one stone for each file in the directory
