...
Resulst are saved in result_all/metrics_reference_wall.txt
"""
...
data_dir_prefix = "./data/stones_noise_"

#write metrics
with open(result_dir+f'metrics_reference_wall.txt', 'a+') as f:
    f.write('wall_id;wall_stone_ratio;FAV;FAH;lm\n')
...
for i in range(10,90,10):
    metrics = np.zeros((4,))
    metrics[0] = i
    wall_image = cv2.imread(data_dir_prefix+f'{i}_labels.png', cv2.IMREAD_GRAYSCALE)
    ...
    cv2.imwrite(data_dir_prefix+f'{i}_labels_for_FAV_FAH.png',wall_eroded_stones)
